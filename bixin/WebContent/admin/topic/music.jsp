...
<div class="music-player">
	...
	<div class="music-player__main">
		...
		<div class="music-player__disc">
			...
			<!-- 指针 -->
			<div class="music-player__pointer"><img width="100%" src="${pageContext.request.contextPath }/images/cd_tou.png" alt=""></div>
		</div>
		<!-- 控件主体 -->
...
<script src="${pageContext.request.contextPath }/js/utill.js"></script>
